...
function load_stylesheets() {
    ...
    wp_register_style('css', get_template_directory_uri() . '/style.css', array(), 1, 'all');
...
// remove image click to zoom features
add_action( 'after_setup_theme', 'remove_image_zoom_hooks', 99 );

function remove_image_zoom_hooks() { 
